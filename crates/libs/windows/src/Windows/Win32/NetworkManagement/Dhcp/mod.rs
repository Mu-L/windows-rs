...
#[doc = "*Required features: `\"Win32_NetworkManagement_Dhcp\"`*"]
pub const DHCP_CALLOUT_ENTRY_POINT: ::windows::core::PCSTR = ::windows::s!("DhcpServerCalloutEntry");
#[doc = "*Required features: `\"Win32_NetworkManagement_Dhcp\"`*"]
pub const DHCP_CALLOUT_LIST_KEY: ::windows::core::PCWSTR = ::windows::w!("System\\CurrentControlSet\\Services\\DHCPServer\\Parameters");
#[doc = "*Required features: `\"Win32_NetworkManagement_Dhcp\"`*"]
