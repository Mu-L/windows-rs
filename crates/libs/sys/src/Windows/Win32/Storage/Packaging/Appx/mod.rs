...
::windows_sys::core::link ! ( "kernel32.dll""system" #[doc = "*Required features: `\"Win32_Storage_Packaging_Appx\"`*"] fn GetCurrentPackageVirtualizationContext ( ) -> *const PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__ );
