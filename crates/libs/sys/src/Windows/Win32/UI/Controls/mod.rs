...
::windows_sys::core::link ! ( "comctl32.dll""system" #[doc = "*Required features: `\"Win32_UI_Controls\"`*"] fn DPA_DeletePtr ( hdpa : HDPA , i : i32 ) -> *const ::core::ffi::c_void );
#[cfg(feature = "Win32_Foundation")]
...
::windows_sys::core::link ! ( "comctl32.dll""system" #[doc = "*Required features: `\"Win32_UI_Controls\"`*"] fn DPA_GetPtr ( hdpa : HDPA , i : isize ) -> *const ::core::ffi::c_void );
...
::windows_sys::core::link ! ( "comctl32.dll""system" #[doc = "*Required features: `\"Win32_UI_Controls\"`*"] fn DSA_GetItemPtr ( hdsa : HDSA , i : i32 ) -> *const ::core::ffi::c_void );
